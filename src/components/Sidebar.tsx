...
import { BarChart3, Upload, FileText, BarChart, LineChart } from 'lucide-react';
...
const Sidebar: FC<SidebarProps> = ({ className, currentPage, onNavigate }) => {
  ...
  return (
    <div className={cn(
      'w-64 bg-card border-r h-screen p-4 flex flex-col fixed left-0 top-0 z-50 shadow-sm sidebar-transition',
      className
    )}>
